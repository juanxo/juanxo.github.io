(function(){
  ...
  // Define this var in console before clicking on the bookmarklet
  // to change the host of css-rule-checker and its dependencies
  var host = CSSRuleChecker.host || "http://juanxo.github.io";
  ...
  var loadDependenciesAndRun = function() {
    ...
    var dependenciesPromise = [
      loadDependency(window._ && window._.VERSION > "1.4.4", CSSRuleChecker.host + '/scripts/underscore-min.js'),
      loadDependency(null, CSSRuleChecker.host + '/scripts/css-rule-checker/statistics.js')
    ];
